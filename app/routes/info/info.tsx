...
const cardsInfo: InfoCard[] = [
  {
    ...
    description:
      "Suve jooksul toimub 4 erinevat laagrivahetust, igaüks erineva ilma, tegevuskava ja seltskonnaga. Üks täispikk vahetus kestab 12 päeva ja lühike vahetus 7 päeva. Enamasti tahavad lapsed tagasi tulla juba tuttavasse vahetusse, ent alati on ka neid, kes soovivad erinevad vahetused läbi proovida, sest sõpru leiab alati.",
